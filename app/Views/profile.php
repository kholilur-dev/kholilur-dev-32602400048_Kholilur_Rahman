...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .nim { font-size: 14px; color: #6366f1; font-weight: 600; margin-top: 4px; }
        .major { font-size: 15px; color: #64748b; margin-top: 8px; }
...
<body>
    ...
    <div class="profile-card">
        ...
        <a href="/skill" class="back-link">Lihat Skill saya →</a>
    </div>
